...
public:
     ...
     //! change in active distance restraints.
     bool did_swap;
     ...
     std::vector<AmbiguousContact> read_contact_map(CHAIN_TYPE *chain, std::istream &input_stream) {
          ...
          while (input_stream.good()) {
               ...
               std::cout << "# restraints: " << split_line << " interpreted as ";
     ...
     //! Calculate the shortest distance between two sets of atoms involved in a restraint.
